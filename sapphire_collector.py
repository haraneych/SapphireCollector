...
def output_allresult(hybridanalysis_result_json,triage_result_json,virustotal_result_json):
    print(f"""
<name>
...
def main():
    ...
    if args.output is None:
        output_allresult(hybridanalysis_result_json,triage_result_json,virustotal_result_json)
    else:
